...
export default function ExpensesForm() {
  ...
  return (
    <div className="md:mx-full bg-gray-950/90 border border-green-400/30 rounded-xl shadow-lg shadow-green-900/40 p-8">
      ...
      <form onSubmit={handleSubmit} className="flex flex-wrap gap-6 items-end">
        ...
        <div>
          <button
            type="submit"
            className="mt-6 w-fit px-6 py-2 bg-green-400 hover:bg-green-300 text-gray-900 rounded-lg font-semibold transition-all"
          >
            Add
          </button>
        </div>
